...
translate russian v1s24_PhoneContinueAmber_88d710ce:

    # u "(I should check my phone.)"
    u "(Я должен проверить свой телефон.)"

# game/v1/scene24.rpy:33
translate russian v1s24_PhoneContinueAmber_3370cc73:
...
translate russian v1s24_PhoneContinueAmber_35d926e6:

    # u "(Oh, shit... You know what? I still have some extra money from that scummy night gambler.)"
    u "(О, чёрт... Знаешь что? У меня еще есть немного лишних денег от того мерзкого ночного напёрсточника)."

# game/v1/scene24.rpy:44
translate russian v1s24_PhoneContinueAmber_1766ecfb:
