...
translate russian v1s43_PhoneContinueEmily_88d710ce:

    # u "(I should check my phone.)"
    u "(Я должен проверить свой телефон.)"

# game/v1/scene43.rpy:54
translate russian v1s43_PhoneContinueEmily_ef9ea744:

    # u "(Glad to see that Emily's still up to no good, haha.)"
    u "(Рад видеть, что Эмили всё ещё ничего хорошего не замышляет, хаха)."

# game/v1/scene43.rpy:69
translate russian v1s43_PhoneContinueEmily_9c004e59:

    # u "This seat taken?"
    u "Это место занято?"

# game/v1/scene43.rpy:75
translate russian v1s43_PhoneContinueEmily_caafc8e1:

    # pe "Saved, actually."
    pe "Вообще-то, занято."

# game/v1/scene43.rpy:80
translate russian v1s43_PhoneContinueEmily_cab2a430:

    # u "Oh?"
    u "О?"

# game/v1/scene43.rpy:85
translate russian v1s43_PhoneContinueEmily_8e880ca5:
...
translate russian v1s43_PhoneContinueEmily_1743b6c3:

    # pe "Sit down already, weirdo. *Chuckles*"
    pe "Садись уже, чудик. *Хихикает*"

# game/v1/scene43.rpy:98
translate russian v1s43_PhoneContinueEmily_74e10c99:

    # pe "That depends..."
    pe "Это зависит от..."

# game/v1/scene43.rpy:103
translate russian v1s43_PhoneContinueEmily_c386ccf3:

    # u "On what?"
    u "От чего?"

# game/v1/scene43.rpy:108
translate russian v1s43_PhoneContinueEmily_f2b59b77:
...
translate russian v1s43_PhoneContinueEmily_478ca63d:

    # u "Wait, how do you even-"
    u "Подожди, что это вообще-"

# game/v1/scene43.rpy:128
translate russian v1s43_PhoneContinueEmily_0556128a:

    # pe "Sit down already, would you? People are starting to stare... *Laughs*"
    pe "Сядь уже. А то люди уже начинают пялиться... *Смеётся*"

# game/v1/scene43.rpy:138
translate russian v1s43_PhoneContinueEmily_5441fb2f:

    # u "*Laughs* Good one."
    u "*Смеётся* Хорошо."

# game/v1/scene43.rpy:143
translate russian v1s43_PhoneContinueEmily_fb5c9743:
